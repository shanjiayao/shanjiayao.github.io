...
```
npm install hexo
echo 'PATH="$PATH:~/disks/HexoBlogs/node_modules/.bin' >> ~/.zshrc
```
...
https://github.com/chenyingzhou/deepin-wine-ubuntu
...
https://blog.diqigan.cn/posts/wine-wechat-black-square-fix.html
...
https://octopuslian.github.io/2019/11/13/ubuntu1804-ffmpeg-install/
...
https://appmaker.xyz/web2desk/将notion桌面化
